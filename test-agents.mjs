...
function piMock(options = {}) {
    ...
    const hooks = new Map();
    const calls = { active: [...(options.active ?? ["wire_list", "wire_send", "wire_respond"])], setModel: 0, setTools: 0, entries: [], notices: [], custom: [], tools: new Map(), shortcuts: new Map(), messages: [] };
    const ctx = {
